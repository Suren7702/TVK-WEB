...
// ==========================================
// 1. GET FULL NETWORK (Public/Unauthenticated)
// ==========================================
...
// ==========================================
// 2. ADD UNIT (Secured/Authenticated)
// ==========================================
export const addPartyUnit = async (req, res) => {
    try {
        // NOTE: Auth check (token validation) should happen here if not done in middleware.
        // For simplicity, we assume checkAuth passed the API Key check.
...
// ==========================================
// 3. DELETE UNIT (Secured/Authenticated)
// ==========================================
...
// ==========================================
// 4. UPDATE UNIT (Secured/Authenticated)
// ==========================================
